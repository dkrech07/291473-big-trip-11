...
/***/ "./src/components/trip-form.js":
/*!*************************************!*\
  !*** ./src/components/trip-form.js ***!
  \*************************************/
/*! exports provided: createTripFormTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createTripFormTemplate", function() { return createTripFormTemplate; });
...
/* harmony import */ var _components_trip_day_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/trip-day.js */ "./src/components/trip-day.js");
/* harmony import */ var _components_trip_event_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/trip-event.js */ "./src/components/trip-event.js");
/* harmony import */ var _components_trip_form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/trip-form.js */ "./src/components/trip-form.js");
...
renderComponent(tripMenu, Object(_components_trip_info_js__WEBPACK_IMPORTED_MODULE_6__["createTripInfoTemplate"])(), `afterbegin`);
renderComponent(tripSwitch, Object(_components_menu_js__WEBPACK_IMPORTED_MODULE_1__["createMenuTemplate"])(), `afterend`);
renderComponent(tripFilter, Object(_components_filters_js__WEBPACK_IMPORTED_MODULE_0__["createFiltersTemplate"])(), `afterend`);

const mainContainer = document.querySelector(`.page-body__page-main`);
const tripEvents = mainContainer.querySelector(`.trip-events`);

renderComponent(tripEvents, Object(_components_sorting_js__WEBPACK_IMPORTED_MODULE_2__["createSortTemplate"])(), `beforeend`);
renderComponent(tripEvents, Object(_components_trip_form_js__WEBPACK_IMPORTED_MODULE_5__["createTripFormTemplate"])(), `beforeend`);
renderComponent(tripEvents, Object(_components_trip_day_js__WEBPACK_IMPORTED_MODULE_3__["createTripDayTemplate"])(), `beforeend`);
...
renderComponent(tripEventList, Object(_components_trip_event_js__WEBPACK_IMPORTED_MODULE_4__["createTripEventTemplate"])(), `beforeend`, TRIP_POINT_COUNT);
